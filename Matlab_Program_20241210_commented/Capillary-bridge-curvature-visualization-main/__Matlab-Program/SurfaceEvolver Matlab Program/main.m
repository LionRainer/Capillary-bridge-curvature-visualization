...
Preview_centers(x,y,z,diameters,0.1);
...
Visualizesection(Mdatapolar,botval,topval,10,4);

% 2 = 3D Pointclouds with GC and MC Coloring
Visualizesection(Mdatacart,botval,topval,10,2);
...
Visualizesection(Mdatapolar,botval,topval,12,3);
